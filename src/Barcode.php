...
class Barcode
{
    ...
    protected static $typeclass = array(
        ...
        'DATAMATRIXR'    => 'Square\\DatamatrixRectangular',     // DATAMATRIX Rectangular (ISO/IEC 16022)
        'GS1DATAMATRIX'  => 'Square\\GS1Datamatrix',             // GS1 DATAMATRIX (ISO/IEC 16022)
        'GS1DATAMATRIXR' => 'Square\\GS1DatamatrixRectangular',  // GS1 DATAMATRIX Rectangular (ISO/IEC 16022)
