...
class Data
{
    ...
    public const SYMBATTR = ['S' => [
        ...
        // 144x144
        [0x090, 0x090, 0x084, 0x084, 0x018, 0x018, 0x016, 0x016, 0x006, 0x006, 0x024, 0x618, 0x26c, 0x00a, 0x09c, 0x03e],
    ], 'R' => [
        // rectangular form
        // 8x18
        ...
        */
    public const CHSET_ID = [self::ENC_C40 => 'C40', self::ENC_TXT => 'TXT', self::ENC_X12 => 'X12'];

        /**
        * Basic set of characters for each encodation mode.
        */
        public const CHSET = ['C40' => [
            // Basic set for C40
            'S1' => 0x00,
            'S2' => 0x01,
            'S3' => 0x02,
