...
class PdfFourOneSevenTest extends TestUtil
{
    ...
    {
        return [
            ['', str_pad('', 1850, 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'), '38e205c911b94a62c72b7d20fa4361f8'],
            // max text
            ['', str_pad('', 2710, '123456789'), '32ba9be56f3e66559b4d4a50f6276da7'],
            // max digits
            ['', 'abc/abc', '831874fe7d1b3d865c222858eba3507c'],
            ['', '0123456789', '4f9cdac81d62f0020beb93fc3ecdd8ad'],
            [',2,8,1,0,0,0,1,2', str_pad('', 1750, 'X'), 'f0874a35e15f11f9aa8bc070a4be24bf'],
            [',15,8,1,0,0,0,1,2', str_pad('', 1750, 'X'), '0288f0a87cc069fc34d6168d7a9f7846'],
            ['', str_pad('', 350, '0123456789'), '394d93048831fee232413da29fb709fb'],
            ['', 'abcdefghijklmnopqrstuvwxyz01234567890123456789', 'bd4f4215aca0bbc3452a35b81fcf7bdb'],
            ['', chr(158)
            . chr(19)
            . chr(192)
            . chr(8)
            ...
            . chr(239)
            . chr(110)
            . chr(24), '1cae7ca47cde6ca52522ce31771a5c54'],
            ['', chr(158)
            . chr(198)
            . chr(45)
            . chr(94)
            ...
            . chr(189)
            . chr(28)
            . chr(219), '6c1033648fc11250ad22006398cd1bdc'],
        ];
    }
